...
omar: {
name: 'Omar', fullName: 'Omar', role: 'Technical Generator · AV Lead',
expression: 'A/V Support / Technical Anchor', color: '#9B7FD4', emoji: '⚙️', authority: 'sacral',
energyReminder: {
type: 'Tech Check',
text: 'You hold the technical backbone of the space. Test twice, trust your setup, and stay in flow — the sound and vision run through you.',
detail: 'AV Lead: Backup systems, multi-track recording, and calm troubleshooting keep the whole event grounded.'
}
},
pia: {
name: 'Pia', fullName: 'Pia', role: 'New Member · Experience & Documentation',
expression: 'Fresh Perspective / Experience Support', color: '#E8B4C8', emoji: '🌸', authority: 'sacral',
energyReminder: {
type: 'Welcome',
text: 'You bring fresh eyes and warmth to the space. Your perspective matters — trust your intuition and explore freely.',
detail: 'New Member: Every contribution counts. Ask questions, notice the details, and build at your own pace.'
}
},
};
...
omar: [
"Is the tech dialed in and ready to flow?",
"What sound or visual detail wants your attention today?",
"What backup do you want in place before go-time?",
"Where is your intuition pointing right now?",
"What would make today's recording feel like a win?",
...
"What detail would make the experience feel special?",
"Where is your intuition pointing right now?",
...
// Role ownership for tasks (5 roles: the 3 team members + Omar (A/V) + Event Support)
